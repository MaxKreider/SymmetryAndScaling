...
%visualize the error
figure(1)
loglog(NN,err_vec_avg,'k-','linewidth',1.5)
hold on
loglog(NN,err_vec_avg,'k.','markersize',30)
loglog(NN,(log(NN).^(ell).*NN.^(1-ell)),'r-','linewidth',1.5)
loglog(NN,(log(NN).^(ell).*NN.^(1-ell)),'r.','markersize',30)
xlabel('N')
ylabel('||sin(\Theta)||_2')
set(gca,'fontsize',15)
box on
